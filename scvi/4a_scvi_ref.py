...
ref_adata = sc.read_h5ad(
    "project-area/data/crohns_scrnaseq/scvi_tools_output/Full_obj_raw_counts_nosoupx_v2.h5ad"
)
...
model.train(
    max_epochs=200, batch_size=2048, early_stopping=True, check_val_every_n_epoch=1
)
