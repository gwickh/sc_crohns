...
def train_scanvi_ref(scvi_path, label: str = "Integrated_05") -> None:
...
def train_scanvi_query(
    ...
    labels_soft.to_csv(
        scvi_path / f"query_soft_labels_{label}.csv",
        sep="\t",
    )
